...
import random
def randomizer():
    randTeam = random.randint(0,3)-1 #random number from 0 to 2
    team = list(KREWES.keys())[randTeam] #the random team that is picked
    randMember = random.choice(KREWES[team]) #picks a random member of the team
    return randMember #returns the random member
print(randomizer())    
